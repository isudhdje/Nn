...
async def approve(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def remove(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode='Markdown')
        return
...
async def addadmin(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode="Markdown")
        return
...
async def addbalance(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode="Markdown")
        return
...
async def adminbalance(update: Update, context: CallbackContext.DEFAULT_TYPE):
    admin = collection.find_one({"user_id": update.effective_user.id})
...
async def gen(update: Update, context: CallbackContext.DEFAULT_TYPE):
    user_id = update.effective_user.id
...
async def redeem(update: Update, context: CallbackContext.DEFAULT_TYPE):
    user_id = update.effective_user.id
    try:
...
async def removeadmin(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode="Markdown")
        return
...
async def removecoin(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode="Markdown")
        return
...
async def set_attack_limit(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode="Markdown")
        return
...
async def bgmi(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def handle_photo(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def maintenance_mode(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def clear_attack(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def set_thread(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode="Markdown")
        return
...
async def howtoattack(update: Update, context: CallbackContext.DEFAULT_TYPE):
    await update.message.reply_text(
        "📖 *Learn How to Attack:*\n"
...
# Command for /canary
async def canary(update: Update, context: CallbackContext.DEFAULT_TYPE):
    keyboard = [
...
async def rule(update: Update, context: CallbackContext.DEFAULT_TYPE):
    rule_message = "⚠️ *Rule: Ek Time Pe Ek Hi Attack Lagana*\n\n💫 The owner of this bot is ❄️DAKU BHAIZ❄️. Contact @DAKUxBHAIZ."
    await update.message.reply_text(rule_message, parse_mode='Markdown',
    reply_markup=get_default_buttons())

async def owner(update: Update, context: CallbackContext.DEFAULT_TYPE):
    await update.message.reply_text(
        f"👤 *The owner of this bot is {ADMIN_USERNAME}.*\n"
        f"✉️ *Contact:* {ADMIN_CONTACT}\n\n", parse_mode='Markdown'
    )

async def myinfo(update: Update, context: CallbackContext.DEFAULT_TYPE):
    user = update.effective_user
    user_data = collection.find_one({"user_id": user.id})
    now = datetime.now()
...
async def admincommand(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
...
async def users(update: Update, context: CallbackContext.DEFAULT_TYPE):
    if update.effective_user.id != ADMIN_ID:
        await update.message.reply_text("🚫 *You are not authorized to use this command.*", parse_mode="Markdown")
        return
...
async def uptime(update: Update, context: CallbackContext.DEFAULT_TYPE):
